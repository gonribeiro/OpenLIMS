...
final class SampleTable extends PowerGridComponent
{
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('EXTERNAL ID', 'external_id')
                ->searchable()
                ->makeInputText(),
            ...
            Column::make('DISCARDED', 'discarted_date')
                ->searchable()
                ->makeInputText(),

            Column::make('DISCARDED BY', 'discarted_by_id')
                ->searchable()
                ->makeInputText(),
        ];
    }
